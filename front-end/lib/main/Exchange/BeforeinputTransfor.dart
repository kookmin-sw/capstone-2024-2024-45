...
class BeforeInputTransfor extends StatefulWidget {

  const BeforeInputTransfor({Key? key}) : super(key: key);

  @override
  State<BeforeInputTransfor> createState() => _InputTransforState();
}

class _InputTransforState extends State<BeforeInputTransfor> {
